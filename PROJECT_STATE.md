...
- **C16 Saved Events / Bookmarks: implemented — awaiting review.** Reuses C03 saved_events and RLS, with shared server-confirmed save controls on Explore/Detail/For You and a private 24-item keyset-paginated Saved page. One query-plan-justified ordering index is applied; all nine migration versions match. Local regressions, browser transitions, performance and 29 hosted checks passed; both exact temporary accounts/dependents were deleted and all inventory counts restored. No hosted events were created. See docs/section-36-c16-review.md. C16 is uncommitted/unpushed pending approval. **C18, calendar and notifications have not started.**
