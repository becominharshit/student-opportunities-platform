...
export default async function Page({ searchParams }: { searchParams: Promise<{ message?: string }> }) {
 ...
 <nav aria-label="Account actions" className="flex flex-wrap gap-4 underline"><a href="/for-you">For You</a><a href="/account/profile">Edit profile</a><a href="/onboarding">Guided onboarding</a><a href="/explore">Explore opportunities</a></nav>
