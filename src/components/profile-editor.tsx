...
export function ProfileEditor({data,onboarding=false}: {data:ProfileData;onboarding?:boolean}) {
 ...
 return <main id="main-content" className="mx-auto max-w-3xl space-y-5 px-5 py-10"><nav aria-label="Profile navigation" className="flex flex-wrap gap-5 underline"><a href="/for-you" className="underline">For You</a><a href="/account">Account</a><a href="/explore">Explore</a></nav>
