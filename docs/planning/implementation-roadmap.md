...
| M4 — Discovery and relevance | IN PROGRESS; C12 approved with C12.5 hosted sign-off | C12 migration applied and hosted empty-inventory/API/UI checks passed; C13–C16 not started. Stop after C12.5 |
